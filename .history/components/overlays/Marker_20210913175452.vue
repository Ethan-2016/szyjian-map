...
export default {
  ...
  methods: {
    load () {
      const {BMap, map, position, offset, icon, massClear, dragging, clicking, raiseOnDrag, draggingCursor, rotation, shadow, title, label, top, renderByParent, $parent, zIndex} = this
